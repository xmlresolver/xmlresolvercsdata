...
namespace UnitTests {
    ...
    [Test]
    public void Gen_lookupPublicd1e93() {
    ...
    [Test]
    public void Gen_lookupUrid1e96() {
    ...
    [Test]
    public void Gen_lookupPublicd1e351() {
        Uri result = manager.LookupPublic(null, "-//W3C//ELEMENTS SVG 1.1 Marker//EN");
        Assert.NotNull(result);
    }

    [Test]
    public void Gen_lookupSystemd1e352() {
    ...
    [Test]
    public void Gen_lookupPublicd1e382() {
    ...
    [Test]
    public void Gen_lookupSystemd1e616() {
    ...
    [Test]
    public void Gen_lookupSystemd1e747() {
    ...
    [Test]
    public void Gen_lookupPublicd1e783() {
    ...
    [Test]
    public void Gen_lookupSystemd1e821() {
    ...
    [Test]
    public void Gen_lookupPublicd1e825() {
    ...
    [Test]
    public void Gen_lookupPublicd1e902() {
        Uri result = manager.LookupPublic(null, "-//W3C//ELEMENTS XHTML Ruby 1.0//EN");
        Assert.NotNull(result);
    }

    [Test]
    public void Gen_lookupSystemd1e903() {
    ...
    [Test]
    public void Gen_lookupPublicd1e946() {
        Uri result = manager.LookupPublic(null, "-//W3C//DTD XHTML 1.0 Strict//EN");
        Assert.NotNull(result);
    }

    [Test]
    public void Gen_lookupSystemd1e947() {
        Uri result = manager.LookupSystem("https://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd");
        Assert.NotNull(result);
    }

    [Test]
    public void Gen_lookupPublicd1e949() {
        Uri result = manager.LookupPublic(null, "-//W3C//DTD XHTML 1.0 Transitional//EN");
        Assert.NotNull(result);
    }

    [Test]
    public void Gen_lookupSystemd1e950() {
